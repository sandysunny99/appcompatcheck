...
async function main() {
  console.log('🚀 Setting up AppCompatCheck Database...');
  
  const POSTGRES_URL = 'postgresql://postgres:OuVGhVpr@127.0.0.1:5432/appcompatcheck';
  ...
  console.log('🎉 AppCompatCheck setup completed successfully!');
